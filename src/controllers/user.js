...
const secret_app = global.secret;
                ...
                token.save(async (err) => {
                  if (err) {
                    return res.send({
                      statue: 'error',
                      msg:
                        'Something went wrong during sending verify message!',
                      data: err.message,
                    });
                  }
                  var params = {
                    ...
                    Source: global.AWS_source /* required */,
                  };
                  // Create the promise and SES service object
                  var sendPromise = new AWS.SES({ apiVersion: '2010-12-01' })
                    .sendEmail(params)
                    .promise();
                  console.log('start sending mail to ', params);
                  ...
                  sendPromise
                    ...
                    .catch(function (err) {
                      ...
                      return res.send({
                        statue: 'error',
                        msg:
                          'Something went wrong during sending verify message!123',
                        data: err.message,
                      });
                    });
                });
